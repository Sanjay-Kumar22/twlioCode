        ...
        <div class="row justify-content-center">
          <div class="col-md-9">
            ...
            <table id="example" class="display">
              ...
              <tbody>
              <?php 
              $sql = "SELECT * FROM contact_list WHERE  `contact_mobile` !='' LIMIT 500 ";
              $result = mysqli_query($conn, $sql);
              
              if($result && mysqli_num_rows($result) > 0){
                while($row = mysqli_fetch_assoc($result)){ ?>
                  <tr>
                    <td><input type="checkbox" class="rowCheckbox" value="+61<?php echo $row['contact_mobile']; ?>" data-name="<?php echo $row['contact_name']; ?>"></td>
